 ...
 *  sub-package with different path. for example `_goji_runtime.js` and `independent-test/_goji_runtime.js`
 ...
 * this plugin hacks the `_goji_runtime.js` to ensure there is always a singleton of runtime context
 */
